...
public class UserChoiceService {
    ...
    public boolean existsByUserAndContainerId(Long userId, Long containerId){
        return userChoiceRepository.existsByUserIdAndContainerId(userId, containerId);
    }

    public UserChoice createUserChoice (UserChoice userChoice){
