...
public class UserController {
    ...
    public String loginForm(@RequestParam String username, @RequestParam String password, HttpServletRequest request, HttpServletResponse response, Model model) throws JsonMappingException, JsonProcessingException{
        ...
        if(password.equals(user.getPassword())){
            if(cookies != null){
                for(Cookie cookie : cookies){
                    ...
                    cookie.setMaxAge(1000); // Устанавливаем срок действия куки
                    response.addCookie(cookie); // Обновляем куку
        ...
        newCookie.setMaxAge(300);  // Устанавливаем срок действия куки
        newCookie.setPath("/");     // Устанавливаем путь доступности куки
